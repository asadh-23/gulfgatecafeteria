    ...
    <div className="flex flex-col items-center space-y-6">
      ...
      <div className="w-full max-w-xl bg-white rounded-xl border border-gray-200 overflow-hidden">
        ...
        <div className="px-6 py-5 border-b border-gray-100 text-center relative">
          <button 
            onClick={openModal} 
            className="absolute right-4 top-4 p-2 text-gray-400 hover:text-green-600 bg-gray-50 hover:bg-green-50 rounded-lg transition-colors shadow-sm border border-gray-100"
            title="Edit Profile"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
